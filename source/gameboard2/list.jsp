...
<head>
 ...
 <%
   ...
   try {
      ...
      int sort=1;
      String sqlSort = "SELECT NUM from board2 order by REF desc, STEP asc";
      rs = stmt.executeQuery(sqlSort);
   
      
      while(rs.next()){
         int stepNum = rs.getInt(1);
         sql = "UPDATE board2 SET STEP=" + sort + " where NUM=" +stepNum;
      ...
      String sqlList = "SELECT NUM, USERNAME, TITLE, TIME, HIT, INDENT from board2 where STEP >="+start + " and STEP <= "+ end +" order by STEP asc";
...
<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Main -->
					...
					<div class="inner">
							<header>
								<h2>플레이하고 싶은 게임을 요청할 수 있습니다.</h2>
							</header>
							</div>
							<center>
							<br><p style="font-size:40px;">요청 게시판</p></center>
