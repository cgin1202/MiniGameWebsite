...
<head>
 ...
 <%
   ...
   try {
      ...
      int sort=1;
      String sqlSort = "SELECT NUM from board3 order by REF desc, STEP asc";
      rs = stmt.executeQuery(sqlSort);
   
      
      while(rs.next()){
         int stepNum = rs.getInt(1);
         sql = "UPDATE board3 SET STEP=" + sort + " where NUM=" +stepNum;
      ...
      String sqlList = "SELECT NUM, USERNAME, TITLE, TIME, HIT, INDENT from board3 where STEP >="+start + " and STEP <= "+ end +" order by STEP asc";
			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<header>
								<h2>게임의 공략을 볼 수 있으며 평균 게임 점수가 일정 점수 이상시 글쓰기가 가능합니다.</h2>
							</header>
							</div>
							<center>
							<br><p style="font-size:40px;">공략 게시판</p></center>
